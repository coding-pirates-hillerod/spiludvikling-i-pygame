...
# Step 1 - Initialisere "game_over" variabel til "False"
game_over = False
...
class Spaceship(pygame.sprite.Sprite):
    ...
    def update(self) -> None:
        ...
        # Step 3 - Tjek for kollision med "Alien group"
...
class Alien(pygame.sprite.Sprite):
    ...
    def update(self) -> None:
        # Step 4 - Tjek for "Alien" bevægelse
        global game_over
...
while run:
    ...
    # Step 5 - Tjek for tilføjelse af "Aliens"
    if not game_over:
